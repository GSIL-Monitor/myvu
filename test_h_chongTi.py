...
class Adddrawout(unittest.TestCase):
    ...
    def test_2tixian(self,data):
        ...
        #提现body
        # body={"data":{"tranAmount":int(data)-2,"payPassword":"111111","configPassword":"","token1":"90473621-9771-4383-9bfd-026c52c84832"},"meta":{"clientType":"0","pageCode":"userWithdraw"}}
        #充值body
        i=0
        while i<10:
            body1={"data":{"tranAmount":4500,"payPassword":"111111","configPassword":"222222"},"meta":{"clientType":"0","pageCode":"userQuickRecharge"}}
            res2 = self.login.BBLCQQ('POST', url1, body1)
            i +=i
        # res1=self.login.BBLCQQ('POST',url,body)
        # print (res)
        ...
        # logger.info(res)
        # print (res1)
        # self.assertEqual(res1['message']['content'],'提现申请成功')
