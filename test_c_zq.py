...
class AddZQ(unittest.TestCase):
    ...
    def test_3uploadZQ(self):
        '''发布理财计划'''
        name = cf.get('ZQ','name')
        amount = cf.get('LCJH', 'amount')   #理财计划和债权公用一个amount
        creditAmount = cf.get('LCJH', 'amount')
        period = cf.get('ZQ', 'period')
        ...
        rate = cf.get('ZQ', 'rate')
        global loanID
        url1 = "http://192.168.1.133/bbl-console/plan/single_import_loan"
        headers1 = {
        ...
        body1 = {'requestType': 'json',
                 'name': '债权-'+contractNo_day+'-'+contractNo_time,
                 'amount': amount,
                 'rate': rate,
                 'period': period,
                 'periodType': '01',
                 ...
                 'userName': "张三",
                 'userAccount': "test12",
                 'userCellphone': "18621137962",
                 'userIdnum': "130629198712311335",
                 'userPassword': '311335',
                 'contractNo': str(a)+contractNo_day+contractNo_time,
                 'contractName': '张三',
                 'contractIdnum': '130629198712311335',
                 'rank': 'B',
                 'feeConsult': '0', #咨询费
                 'feeAudit': '0',   #评估费
                 'feeService': '0',  # 管理费
                 ...
                 'feeMonthly': '0', #月缴服务费
                 'feeHandling': '0',    #手续费
                 'feeAdvanceProtection': '0', #提前还款保障金
                 'creditAmount': amount,
                 'interest': '0',
                 'loanCategory': '0',
                 'desc': '测试1000',
                 'bankName': '中国工商银行',
                 'bankCardAccount': '6222021001029775464',
                 'repay': 'd434ec52-e6e2-440c-9021-f94ef02bc113',
                 'creditWay': '0',
                 'deductWay': '0',
                 'matchType': '216ffa97-40b4-11e5-bfb9-00163e001ddd',
                 'channelCode': '00000'
                 }
